...
export const triggerClass = 'tw:border-0 tw:bg-transparent tw:inline-flex tw:h-7 tw:items-center tw:justify-between tw:gap-1.5 tw:rounded-md tw:px-2 tw:text-sm tw:text-muted-foreground tw:hover:bg-muted tw:focus-visible:outline-2 tw:focus-visible:outline-ring tw:focus-visible:outline-offset-2 tw:disabled:opacity-50';
