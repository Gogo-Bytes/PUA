...
export function NotificationsPreview() {
  ...
  return <div className="preview-completion-stack">
    ...
    <details className="preview-stress"><summary>长内容与多层导航压力案例</summary><div className="preview-completion-stack">
      <Breadcrumbs label="多层导航" items={[{ id: 'home', label: '工作台', onSelect: () => setDetails(true) }, { id: 'team', label: '产品设计', onSelect: () => setDetails(true) }, { id: 'project', label: 'Atlas', href: '#atlas' }, { id: 'release', label: '九月发布', onSelect: () => setDetails(true) }, { id: 'review', label: '组件密度与键盘可访问性审阅', onSelect: () => setDetails(true) }, { id: 'current', label: '核对通知、会话与检查器在较窄窗口中的完整标题及交互目标。'.repeat(3) }]}/>
