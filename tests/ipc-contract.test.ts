...
describe('desktop IPC contract', () => {
  it('retains exactly the declared invoke/send/event whitelist and unique channels', () => {
    ...
    expect(Object.keys(invokeChannels)).toHaveLength(55);
